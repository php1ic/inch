      ...
      while (getline(file,*line))
	{
	  if (line->find("non-exist") == std::string::npos)
	      ...
	      else
		{
		  ...
		  if      (hl_u == "ys") hl_t = hl_t*1.0e-24;
		  else if (hl_u == "zs") hl_t = hl_t*1.0e-21;
		  else if (hl_u == "as") hl_t = hl_t*1.0e-18;
		  else if (hl_u == "ps") hl_t = hl_t*1.0e-12;
		  else if (hl_u == "ns") hl_t = hl_t*1.0e-09;
		  else if (hl_u == "us") hl_t = hl_t*1.0e-06;
		  else if (hl_u == "ms") hl_t = hl_t*1.0e-03;
		  else if (hl_u == " s") hl_t = hl_t*1.0;
		  else if (hl_u == " m") hl_t = hl_t*60.0;
		  else if (hl_u == " h") hl_t = hl_t*3600.0;
		  else if (hl_u == " d") hl_t = hl_t*86400.0;
		  else if (hl_u == " y") hl_t = hl_t*31557600.0;
		  else if (hl_u == "ky") hl_t = hl_t*31557600*1.0e03;
		  else if (hl_u == "My") hl_t = hl_t*31557600*1.0e06;
		  else if (hl_u == "Gy") hl_t = hl_t*31557600*1.0e09;
		  else if (hl_u == "Ty") hl_t = hl_t*31557600*1.0e12;
		  else if (hl_u == "Py") hl_t = hl_t*31557600*1.0e15;
		  else if (hl_u == "Ey") hl_t = hl_t*31557600*1.0e18;
