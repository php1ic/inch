...
const std::map<std::string, int>& SymbolConverter::theMap()
{
...
const std::string SymbolConverter::convertZToSymbol(const int Z) const
{
...
const std::string SymbolConverter::caseCorrection(std::string symbol) const
{
